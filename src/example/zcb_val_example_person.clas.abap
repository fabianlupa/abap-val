class ZCB_VAL_EXAMPLE_PERSON definition
  public
...
CLASS ZCB_VAL_EXAMPLE_PERSON IMPLEMENTATION.
...
************************************************************************
  ...
  data: THE_OBJECT type ref to ZCL_VAL_EXAMPLE_PERSON,
...
************************************************************************
  ...
  data: OBJECT_IREF type TYP_OBJECT_IREF,
        THE_OBJECT  type ref TO ZCL_VAL_EXAMPLE_PERSON.
...
*< Generated from mapping:
  types: TYP_DB_DATA_LOCAL type ZVAL_TAEXPEOPLE.
*>
...
*< Generated from mapping:
  field-symbols: <FS_DB_ZVAL_TAEXPEOPLE> type ZVAL_TAEXPEOPLE.
*>
...
* * error handling
  if ( SY-SUBRC <> 0 ).
    ...
    raise exception type CX_OS_DB_SELECT
         exporting TABLE  = 'ZVAL_TAEXPEOPLE'
...
* * ZVAL_TAEXPEOPLE: internal tables for mass operation
  data DB_ITB_ZVAL_TAEXPEOPLE type STANDARD TABLE OF ZVAL_TAEXPEOPLE.
  data DB_UTB_ZVAL_TAEXPEOPLE type STANDARD TABLE OF ZVAL_TAEXPEOPLE.
  data DB_DTB_ZVAL_TAEXPEOPLE type STANDARD TABLE OF ZVAL_TAEXPEOPLE.

* * ZVAL_TAEXPEOPLE: headlines for tables
  data DB_ILN_ZVAL_TAEXPEOPLE type ZVAL_TAEXPEOPLE.
  data DB_ULN_ZVAL_TAEXPEOPLE type ZVAL_TAEXPEOPLE.
  data DB_DLN_ZVAL_TAEXPEOPLE type ZVAL_TAEXPEOPLE.
...
* * DB Deletes
  delete ZVAL_TAEXPEOPLE FROM TABLE DB_DTB_ZVAL_TAEXPEOPLE.
  if SY-SUBRC <> 0.
    raise exception type CX_OS_DB_DELETE
      exporting
        TABLE = 'ZVAL_TAEXPEOPLE'.
  endif.

* * DB Inserts
  insert ZVAL_TAEXPEOPLE FROM TABLE DB_ITB_ZVAL_TAEXPEOPLE
...
* * DB Updates
  update ZVAL_TAEXPEOPLE FROM TABLE DB_UTB_ZVAL_TAEXPEOPLE.
  if SY-SUBRC <> 0.
...
************************************************************************
  ...
  data: NEW_OBJECT type ref to ZCL_VAL_EXAMPLE_PERSON.
